    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-[#00ea77]/30 selection:text-white font-sans flex flex-col">
      ...
      <main className="flex-1 flex justify-center p-12 lg:p-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl w-full relative z-10">
          ...
          <p className="text-lg text-slate-400 mb-12 border-b border-white/10 pb-8">Last Updated: April 11, 2026. This Privacy Policy explains how KhataX Technologies Pvt. Ltd. collects, uses, and protects your financial and personal data.</p>
          ...
          <div className="prose prose-invert prose-lg max-w-none text-slate-300 space-y-8">
            <div className="flex gap-4">
               ...
               <div>
                 ...
                 <p>When you create an account with us, KhataX safely stores your business profiles, GSTIN details, vendor lists, and inventory information to help you manage your business more efficiently.</p>
               </div>
            </div>
            ...
            <div className="flex gap-4">
               ...
               <div>
                 ...
                 <p>Your data is securely stored while your account is active. If you choose to delete your account, KhataX will permanently remove all your associated data from our servers within 30 days.</p>
               </div>
            </div>
            
            <p className="text-sm mt-12 bg-[#111] p-6 rounded-2xl border border-white/5">
              For any questions regarding your privacy or data export requests, please reach out to our team at <span className="text-[#00ea77]">privacy@khatax.com</span>.
            </p>
          </div>
        </div>
      </main>
