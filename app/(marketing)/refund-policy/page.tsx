...
export const metadata = {
  ...
  description: 'Our policies regarding subscriptions and refunds.',
};
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-[#00ea77]/30 selection:text-white font-sans flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center p-12 lg:p-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl w-full relative z-10">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-6">Refund Policy</h1>
          <p className="text-xl text-[#00ea77] mb-12">Our policies regarding subscriptions and refunds.</p>
          
          <div className="bg-[#111] border border-white/10 rounded-3xl p-8 md:p-12 prose prose-invert max-w-none">
            <p className="text-slate-400 text-lg leading-relaxed mb-6">
              Welcome to the Refund Policy page for KhataX. This page outlines our comprehensive platform capabilities and guidelines tailored for Indian SMBs.
            </p>
